...
const Building = {
  ...
  "building_clone_vats": {
    "name": "Clone Vats",
    "description": "Clone Vats are required for the creation of clone armies.",
    "category": "government",
    "planetModifiers": {
  ...
  "building_nanite_transmuter": {
    ...
    "description": "This factory mass-produces a variety of rare resources using extremely advanced nanites.",
    "category": "manufacturing",
    "cost": {
      "minerals": 1000
    },
  ...
  "building_organic_paradise": {
    ...
    "description": "An AI-controlled artificial paradise designed to satisfy every need a sapient organic being might have, just so long as it does not express a need for self-determination.",
    "childKeys": [
      "building_paradise_dome",
      "building_communal_housing_large"
    ],
  ...
  "building_organic_sanctuary": {
    ...
    "description": "This sanctuary provides a sealed environment where organics can thrive in a safe and above all controlled manner.",
    "category": "unity",
    "childKeys": [
      "building_luxury_residence",
      "building_communal_housing"
